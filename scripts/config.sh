...
# installation paths
readonly PREFIX="${PREFIX:-"$HOME/$PRODUCT_NAME"}"
...
readonly MONGODB_BIN="$BIN_DIR"/mongod
...
#~BOOST_SRC="$SRC_DIR/boost_${BOOST_VERSION}"
...
#~readonly LLVM_DIR="$LLVM_ROOT"/lib/cmake/llvm
