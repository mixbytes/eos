#TODO: remove!
set(GEN_VENDOR        "${PKG_VENDOR}")
set(GEN_PROJECT_NAME  "${PROJECT}")
set(GEN_DESC          "blockchain software")
set(GEN_URL           "${PROJECT_URL}")
set(GEN_EMAIL         "${PKG_CONTACT}")
